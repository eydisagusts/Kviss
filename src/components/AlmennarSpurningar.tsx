...
interface AlmennarSpurningarProps {
...
const AlmennarSpurningar = ({ team, teamName, onSubmit }: AlmennarSpurningarProps) => {
    ...
    <div className="flex flex-col items-center mb-8 border-2 rounded-lg border-white p-4">
      ...
      <div className="grid grid-cols-1 gap-8">
        {answers.map((answer, index) => (
          <div key={`AlmennarSpurningar-${team}-${index}-${answer}`} className="flex items-center justify-between">
...
export default AlmennarSpurningar;